...
M = 'Мастера кода'
V = 'Волшкбники данных'
team1_num = int(input('Количество участников команды %s: ' % (M)))
team2_num = int(input('Количество участников команды %s: ' % (V)))
print("В команде %s участников: %s" % (M, team1_num))
print("В команде %s участников: %s" % (V, team2_num))
print("Итого сегодня в командах участников: %(a)s и %(b)s !" % {'a': team1_num, 'b': team2_num})

score_1 = int(input('Количество задач решённых командой {}: '.format(M)))
score_2 = int(input('Количество задач решённых командой {}: '.format(V)))
print('Команда {} решила задач : {}'.format(M, score_1))
print('Команда {} решила задач : {}'.format(V, score_2))
team1_time = float(input('Время за которое команда {} решила задачи: '.format(M)))
team2_time = float(input('Время за которое команда {} решила задачи: '.format(V)))
print("{} решили задачи за {} с !".format(M, team1_time))
print("{} решили задачи за {} с !".format(V, team2_time))

print(f'Команды решили {score_1} и {score_2} задач')
tasks_total = sum([score_1, score_2])
task_time = sum([team1_time, team2_time])
time_avg = task_time // tasks_total
print(f'"Сегодня было решено {tasks_total} задач, в среднем по {time_avg} секунды на задачу!."')

if score_1 > score_2 or score_1 == score_2 and team1_time > team2_time:
    challenge_result = f"Результат битвы: победа команды {M}!"
elif score_1 < score_2 or score_1 == score_2 and team1_time < team2_time:
    challenge_result = f"Результат битвы: победа команды {V}!"
else:
