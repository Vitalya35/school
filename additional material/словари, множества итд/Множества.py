...
Удаление элементов:
m.remove(4) - удалит 4 из множества, если такого элемента нет то будет ошибка
m.discard(4) - удалит 4 из множества, если такого элемента нет то ошибки не будет
