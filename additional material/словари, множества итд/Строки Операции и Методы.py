...
a.strip() - удаляет знаки со всех сторон, по умолчанию пробельные - пробелы, табуляцию и переносы на новые строик со всех сторон
...
print('Hi, {name_first}'.format(name_first=name), end=" ")  - Hi, name, John.
a=5
b = 3
print('Hi, {a} - {b}'.format(a, b), end=" ")  - Hi, 5 - 3
print('Hi, {a} - {b}'.format(a=b, b=a), end=" ")  - Hi, 3 - 5
